#ifndef SIMULATOR_FILTERS_SHMCOMM_H
#define SIMULATOR_FILTERS_SHMCOMM_H
...
namespace SimulatorSHM {
    ...
    enum BufferState { READING, WRITING, DATA, FREE };

    enum LockMode { WRITE_NO_OVERWRITE, WRITE_OVERWRITE_OLDEST, READ_OLDEST, READ_NEWEST };
